...
export function EventsPopup({
  ...
  return (
    <div
      ...
      <div
        className="sticky top-0 flex items-center justify-between border-b bg-background p-3">
          ...
          events.map((event) => {
            ...
            return (
              <div
                ...
                <EventItem event={event} isFirstDay={isFirstDay} isLastDay={isLastDay} view="agenda" />
              </div>
            );
          })
        )}
