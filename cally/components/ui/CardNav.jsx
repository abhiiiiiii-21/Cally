    ...
    >
      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
          ...
          >
            <div
              className={`hamburger-line w-[30px] h-[2px] bg-current transition-transform duration-300 ease-in-out ${
                isHamburgerOpen ? 'translate-y-[8px] rotate-45' : 'translate-y-0 rotate-0'
              } group-hover:opacity-75`}
            />
            <div
              className={`hamburger-line w-[30px] h-[2px] bg-current transition-transform duration-300 ease-in-out ${
                isHamburgerOpen ? '-translate-y-0 -rotate-45' : 'translate-y-0 rotate-0'
              } group-hover:opacity-75`}
            />
          </div>
