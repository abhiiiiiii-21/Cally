...
export default function TimeLine_01({
  title = "Appointment scheduling made simple",
  description = "Professional scheduling for everyone, from freelancers to Fortune 500s.",
    ...
    <section className="mt-15">
      <div className="container">
        <div className="mx-auto text-center">
          <h1 className="max-w-4xl mb-3 text-5xl font-semibold tracking-tight font-urbanist">
            {title}
          </h1>
          <p className="mb-6 text-base text-neutral-600 font-urbanist">
            {description}
          </p>
        </div>

        <div className="mx-auto mt-15 max-w-4xl space-y-16 md:mt-24 md:space-y-24" >
                            ...
                            <div className="flex justify-end">
                              <Button
                                ...
                                <a href={entry.button.url} target="_blank" rel="noreferrer">
                                  {entry.button.text} 
                                  <ArrowUpRight
                                    className="ml-1.5 h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                                </a>
                              </Button>
                            </div>
                          )}
